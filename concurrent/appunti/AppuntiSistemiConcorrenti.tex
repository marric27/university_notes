...
Un monitor è un \textbf{meccanismo di astrazione dei dati} che fornisce l'incapsulamento di un oggetto astratto e fornisce un insieme di operazioni che sono gli unici mezzi con cui quell'oggetto viene manipolato.
